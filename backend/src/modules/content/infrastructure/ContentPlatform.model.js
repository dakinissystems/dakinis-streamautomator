...
const ContentPlatform = sequelize.define('ContentPlatform', {
  ...
  indexes: [
    { unique: true, fields: ['contentId', 'platform'], name: 'content_platform_unique' },
    { fields: ['status'], name: 'idx_content_platform_status' },
    { fields: ['nextRetryAt'], name: 'idx_content_platform_retry' },
    { fields: ['contentId'], name: 'idx_content_platform_content' },
    { fields: ['platform', 'status'], name: 'idx_content_platform_platform_status' },
  ],
