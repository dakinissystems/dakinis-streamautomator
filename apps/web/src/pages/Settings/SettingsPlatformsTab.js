...
export default function SettingsPlatformsTab({
  ...
  */
  ...
  const renderPlatformRow = ({ key, label, labelKey, noConnect }) => {
    ...
    <div className="space-y-6">
      ...
      {connectedAccountsLoading ? (
        ...
        <div className="space-y-4">
          {PLATFORMS_ACCOUNT.map(renderPlatformRow)}
          <div className="pt-4 border-t border-gray-200 dark:border-gray-700 space-y-3">
            ...
            {PLATFORMS_COMMUNITY.map(renderPlatformRow)}
          </div>
        </div>
      ) : (
