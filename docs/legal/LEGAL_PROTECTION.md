...
1. **LICENSE** - Proprietary software license with restrictions
2. **TERMS_OF_SERVICE.md** - Terms and conditions for service usage
3. **COPYRIGHT_NOTICE.md** - Copyright declaration and ownership

### Key Protections

#### 1. Copyright Protection
- All code, documentation, and assets are copyrighted
- Copyright notices are embedded in source files
- Copyright metadata in HTML files

#### 2. License Restrictions
The proprietary license explicitly prohibits:
...
1. **Document the Infringement**
   ...
   - Document any copied code or assets
...
3. **DMCA Takedown (if hosted online)**
   - File DMCA takedown with hosting provider
   - File DMCA with GitHub/GitLab if code is published
   - File DMCA with domain registrar if website

4. **Legal Action**
   - Consult with an intellectual property attorney
   - File lawsuit for copyright infringement
...
3. **Watermarking**
   - Add invisible watermarks to assets
   - Include unique identifiers in builds
   - Track usage through analytics

4. **Terms of Service Enforcement**
   - Require users to accept ToS
