  ...
  return (
    <div className="space-y-6">
      ...
      <div className="space-y-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 p-4 bg-gray-50 dark:bg-gray-800 rounded-lg min-w-0">
          <div className="flex items-center gap-3 min-w-0 flex-1">
            <Palette className="w-5 h-5 text-gray-600 dark:text-gray-400 flex-shrink-0" />
