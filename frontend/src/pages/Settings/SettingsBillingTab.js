        ...
        {licenseInfo ? (
          <div className="space-y-1 text-sm text-gray-700 dark:text-gray-300">
            <p>
              ...
              {licenseInfo.licenseType === 'monthly' && t('settings.monthly')} {/* Creator plan */}
              {licenseInfo.licenseType === 'quarterly' && t('settings.quarterly')} {/* Pro plan */}
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        {availableLicenses.monthly && (
          <div className="p-4 bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700">
            ...
            <button onClick={() => onPurchase('creator')} disabled={billingLoading} className="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 disabled:opacity-50 w-full">
        ...
        {availableLicenses.quarterly && (
          <div className="p-4 bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700">
            ...
            <button onClick={() => onPurchase('pro_monthly')} disabled={billingLoading} className="px-4 py-2 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 disabled:opacity-50 w-full">
